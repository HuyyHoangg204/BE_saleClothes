...
public class SanPham {
    ...
    public SanPham(String spMa, String spTen, double spGia, double spGiaCu, String spMoTaNgan, String spMoTaChiTiet, LocalDate spNgayCapNhat, int spSoLuong, String imageMain, String spColor) {
    }

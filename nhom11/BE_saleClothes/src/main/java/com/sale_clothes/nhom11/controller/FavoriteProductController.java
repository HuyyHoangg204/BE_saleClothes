...
public class FavoriteProductController {
    ...
    public ApiResponse<String> addProductFavorite(
            @RequestParam("username") String username, @RequestParam("productId") int productId) {
    ...
    @PreAuthorize("#username == authentication.name or hasRole('ADMIN')")
    public ApiResponse<String> deleteFavoriteByUsername(@RequestParam String username, @RequestParam int productId) {
        try {

...
public class SanPhamController {
    ...
    public ApiResponse<Page<ProductResponseDTO>> getListProductDmcId(
            @PathVariable int idDmc,
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "10") int size,
            @RequestParam(defaultValue = "0") int isSort) {
        Page<ProductResponseDTO> productResponseDTO =
                sanPhamService.getAllProductsByCategory(idDmc, page - 1, size, isSort);
    ...
    public ApiResponse<Page<ProductResponseDTO>> filterListProductDmcId(
            @PathVariable int idDmc,
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "10") int size,
            @RequestParam(defaultValue = "0") int isSort,
        ...
        Page<ProductResponseDTO> productResponseDTO = sanPhamService.filterAllProductsByCategory(
                idDmc, page - 1, size, isSort, sizeClothes, color, fromPrice, toPrice);
        return ApiResponse.<Page<ProductResponseDTO>>builder()
                .result(productResponseDTO)
                .build();
    }

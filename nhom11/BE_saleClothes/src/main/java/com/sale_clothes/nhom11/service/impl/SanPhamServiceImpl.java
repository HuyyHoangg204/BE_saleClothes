...
public class SanPhamServiceImpl implements SanPhamService {
    ...
    public SanPhamDTO createSanPhamDTO(SanPhamDTO sanPhamDTO) {
        SanPham sanPham = SanPhamMapper.INSTANCE.mapToSanPham(sanPhamDTO);
        SanPham savedSanPham = sanPhamRepository.save(sanPham);
        return SanPhamMapper.INSTANCE.mapToSanPhamDTO(savedSanPham);
    }
    ...
    public List<SanPhamDTO> getAllSanPhamDTOs() {
        ...
        for (SanPham sanPham : sanPhams) {
            sanPhamDTOS.add(SanPhamMapper.INSTANCE.mapToSanPhamDTO(sanPham));
        }
        return sanPhamDTOS;
    }
